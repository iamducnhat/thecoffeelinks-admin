    ...
    return (
        <aside className="w-60 bg-background border-r border-border min-h-screen flex flex-col">
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <li key={item.href}>
                                <Link
                                    href={item.href}
                                    className={`flex items-center gap-4 px-3 py-4 text-sm font-bold uppercase tracking-[0.05em] transition-all border-l-4 ${isActive
            ...
            <div className="py-4 px-4 border-t border-border">
                <Link
                    href="/settings"
                    className="flex items-center gap-4 px-3 py-4 text-sm font-bold uppercase tracking-[0.05em] text-neutral-600 hover:bg-neutral-50 hover:text-foreground transition-all"
                >

...
export default function ImageUpload({ value, onChange, bucket = 'products' }: ImageUploadProps) {
    ...
    // For preview, if the value is a remote URL, use it directly.
    // Ideally we might want to check if it's a valid URL.
    const previewUrl = value;
    ...
    const removeImage = () => {
        onChange('');
        // Optional: Could delete from storage here if we wanted to clean up immediately
    };
